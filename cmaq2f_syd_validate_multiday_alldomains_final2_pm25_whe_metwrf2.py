    ...
    try:
        ...
        for station in stations:
            ...
            for parameter_code, parameter_api_name in PARAMETER_API_MAP.items():
                # Simulate selection of observed data (replace with actual data)
                ...
                try:
                    ...
                    if df_obs is None or df_obs.empty:
                        print(f"    No valid data returned from API for {station_name} ({parameter_code}), skipping...")
                        continue
                    # Ensure datetime index and time zone
