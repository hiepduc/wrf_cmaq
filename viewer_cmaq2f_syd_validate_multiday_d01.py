...
base_dir_wrf = "/home/duch/cmaq/khaliaforecast/20240207_M200/esme_local/forecast/run/WRF/run/met_em.d01.*.nc"

# Get all d01 NetCDF files across date subdirectories
file_list = sorted(glob.glob(os.path.join(base_dir, "2024-*/d01/CCTM_ACONC_v532_intel_d01_*.nc")))
